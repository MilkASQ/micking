...
<script>
  export default {
    data() {
      return {
        invest: [
          {id: 201, url: "/", name: '微 · 车贷NO.3006[转]', is_newer: false, number: 13.50, days: 55, percen: 65.50},
          {id: 202, url: "/", name: '微 · 车贷NO.3007[转]', is_newer: false, number: 14.50, days: 105, percen: 35.50},
        ]
      }
    },
    methods: {},
